...
namespace JWTAuthentication.Controllers
{
    ...
    public class PageDataController : ControllerBase
    {
        ...
        public async Task<UserAccData> UserProfileDetails(Token token)
        {
            ...
            UserAccData userAccData = new UserAccData(userAccount.UserName, userAccount.Password, userData);
